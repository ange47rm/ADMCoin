...
class Block {
    ...
    mineBlock(difficulty) {
        while (this.hash.substring(0, difficulty) !== Array(difficulty + 1).join('0')) {
            // With the same properties within the block, the calculated hash value will always be the same.
            // The nonce number allows the calculated hash value to always be different.
            this.nonce++;
            this.hash = this.calculateHash();
        }
